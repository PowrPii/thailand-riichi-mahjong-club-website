...
const PrivacyAndPolicy: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className='flex justify-center flex-col md:w-[50%] mx-8 md:mx-auto my-8'>
                <h1 className='text-4xl text-center p-8 font-bold'>TRMC Privacy Policy</h1>
                <article className='font-medium text-justify'>
                    ...
                    <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a className="underline" href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="external nofollow noopener noreferrer">Free Privacy Policy Generator</a>.</p> <br />
                    <h2 className='text-2xl py-2 font-bold'>Interpretation and Definitions</h2> <br />
                    <h3 className='text-xl py-1 font-bold'>Interpretation</h3> <br />
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company </strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Thailand Riichi Mahjong Club.</p> <br />
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Country </strong> refers to:  Thailand</p> <br />
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Thailand Riichi Mahjong Club, accessible from <a className="underline" href="https://www.thailand-riichi-mahjong-club.com" rel="external nofollow noopener noreferrer" target="_blank">https://www.thailand-riichi-mahjong-club.com</a></p> <br />
                        </li>
                        <li>
                    ...
                    <h2 className='text-2xl py-2 font-bold'>Collecting and Using Your Personal Data</h2> <br />

                    <h3 className='text-xl py-1 font-bold'>Types of Data Collected</h3> <br />

                    <h4 className='py-1 font-bold'>Personal Data</h4> <br />
                    ...
                    <h4 className='py-1 font-bold'>Usage Data</h4> <br />
                    ...
                    <h4 className='py-1 font-bold'>Tracking Technologies and Cookies</h4> <br />
                    ...
                    <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" rel='noreferrer' className='underline'>Free Privacy Policy website</a> article.</p> <br />
                    ...
                    <h3 className='text-xl py-1 font-bold'>Use of Your Personal Data</h3> <br />
                    ...
                    <h3 className='text-xl py-1 font-bold'>Retention of Your Personal Data</h3> <br />
                    ...
                    <h3 className='text-xl py-1 font-bold'>Transfer of Your Personal Data</h3> <br />
                    ...
                    <h3 className='text-xl py-1 font-bold'>Delete Your Personal Data</h3> <br />
                    ...
                    <h3 className='text-xl py-1 font-bold'>Disclosure of Your Personal Data</h3> <br />

                    <h4 className='py-1 font-bold'>Business Transactions</h4> <br />
                    ...
                    <h4 className='py-1 font-bold'>Law enforcement</h4> <br />
                    ...
                    <h4 className='py-1 font-bold'>Other legal requirements</h4> <br />
                    ...
                    <h3 className='text-xl py-1 font-bold'>Security of Your Personal Data</h3> <br />
                    ...
                    <h2 className='text-2xl py-2 font-bold'>Children's Privacy</h2> <br />
                    ...
                    <h2 className='text-2xl py-2 font-bold'>Links to Other Websites</h2> <br />
                    ...
                    <h2 className='text-2xl py-2 font-bold'>Changes to this Privacy Policy</h2> <br />
                    ...
                    <h2 className='text-2xl py-2 font-bold'>Contact Us</h2> <br />

                    <p>If you have any questions about this Privacy Policy, You can contact us:</p> <br />
                    <ul>
                        <li>
                            <p>By email: <br className='md:hidden'/><br className='md:hidden'/><a className="underline" href="&#109;&#097;&#105;&#108;&#116;&#111;&#058;&#97;d&#109;&#105;n&#64;t&#104;a&#105;&#108;&#97;nd-rii&#99;h&#105;&#45;mah&#106;&#111;ng-c&#108;&#117;b&#46;&#99;&#111;&#109;">a&#100;&#109;i&#110;&#64;&#116;&#104;&#97;iland-&#114;&#105;i&#99;hi&#45;m&#97;&#104;jo&#110;&#103;&#45;&#99;&#108;ub.&#99;&#111;m</a></p> <br />
                        </li>
                    </ul>    
                </article>
            </div>
